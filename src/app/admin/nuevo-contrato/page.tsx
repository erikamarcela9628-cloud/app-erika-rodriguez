            ...
            <div className="pt-2">
              ...
              <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-1">
                    <select required id="tipo_servicio" name="tipo_servicio" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 shadow-sm">
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-1">
                    <input required type="number" min="1" defaultValue="1" name="cantidad_sesiones" id="cantidad_sesiones" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 bg-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 shadow-sm" />
                  </div>
                </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-1">
                    <div className="relative rounded-md shadow-sm">
                      ...
                      <input required type="number" min="0" name="valor_total_cop" id="valor_total_cop" className="w-full pl-7 py-2 border border-gray-300 rounded-lg text-gray-900 bg-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 shadow-sm" placeholder="380000" />
                    </div>
                  </div>
                </div>
