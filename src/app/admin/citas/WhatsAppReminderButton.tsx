...
export default function WhatsAppReminderButton({ cita, className }: WhatsAppReminderButtonProps) {
  ...
  const fechaStr = dateObj.toLocaleDateString('es-CO', opcionesFecha)
  ...
  return (
    <a 
      ...
      className={`inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#25D366] hover:bg-[#128C7E] transition-colors ${className || ''}`}
    >
